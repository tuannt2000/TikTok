export const MENU_REPORT = [
    {
        text: "An toàn cho trẻ vị thành niên",
        children: {
        data: [
            {
                text: "Hình ảnh khỏa thân hoặc hoạt động tình dục của trẻ vị thành niên",
                children: {
                    data: [
                        {
            ...
            {
                text: "Lạm dụng hoặc tội phạm nhắm vào trẻ vị thành niên",
                children: {
                    data: [
                        {
            ...
            {
                text: "Hành vi nguy hiểm hoặc bất hợp pháp của trẻ vị thành niên",
                children: {
                    data: [
                        {
                            title: "Lạm dụng hoặc tội phạm nhắm vào trẻ vị thành niên",
    ...
    {
        text: "Hành động và thử thách nguy hiểm",
        children: {
            data: [
                {
                    ...
                    report_text: [
                       ...
                       "Nội dung trình bày hành vi lái xe nguy hiểm",
                       "Nội dung trình bày hoặc cổ động hành vi ăn các chất không ăn được và có thể gây ra tác hại nghiêm trọng",
                       "Nội dung mô tả hoặc cung cấp hướng dẫn về cách thực hiện một hoạt động nguy hiểm",
                       "Trò chơi, thách đố, thử thách nguy hiểm, hay các pha mạo hiểm có thể dẫn đến thương tật hoặc thiệt hại tài sản"
                    ],
                },
            ],
        },
    ...
    {
        text: "Tự tử, tự làm hại bản thân và rối loạn ăn uống",
        children: {
            data: [
                {
                    text: "Tự tử và tự làm hại bản thân",
                    children: {
                        data: [
                            {
                                ...
                                report_text: [
                                   ...
                                   "Nội dung hướng dẫn cách tự tử hoặc cách tự làm hại bản thân",
    ...
    {
        text: "Hình ảnh khỏa thân và hoạt động tình dục của người lớn",
        children: {
            data: [
                {
                    text: "Nội dung khiêu dâm và khoả thân của người lớn",
                    children: {
                        data: [
                            {
                ...
                {
                    text: "Tấn công tình dục hoặc chia sẻ hình ảnh thân mật riêng tư",
                    children: {
                        data: [
                            {
            ...
            data: [
                {
                    ...
                    report_text: [
                       ...
                       "Nội dung khuyến khích hành vi quấy rối có phối hợp",
                       "Nội dung trình bày hành vi bắt nạt thể chất để sỉ nhục người khác",
                       "Nội dung quấy rối tình dục người khác",
                       "Nội dung đe dọa tiết lộ thông tin cá nhân"
                    ],
                },
            ]
        }
    ...
    {
        text: "Chủ nghĩa cực đoan bạo lực",
        children: {
            data: [
                {
                    text: "Các tổ chức thù địch, khủng bố và tội phạm",
                    children: {
                        data: [
                            {
                ...
                {
                    text: "Đe dọa bạo lực hoặc kích động bạo lực",
                    children: {
                        data: [
                            {
                                ...
                                report_text: [
                                   ...
                                   "Lời tuyên bố hoặc hình ảnh cổ động hành vi bạo lực thể chất",
                                   "Kêu gọi mang vũ khí đến một địa điểm nhằm đe dọa hoặc uy hiếp bạo lực đối với một cá nhân hoặc nhóm người",
                                   "Hướng dẫn cách chế tạo hoặc sử dụng vũ khí nhằm kích động bạo lực"
                                ],
                            },
                        ],
                    },
    ...
    {
        text: "Nội dung rác và tương tác giả mạo",
        children: {
            data: [
                {
                    ...
                    report_text: [
                       ...
                       "Mua hoặc bán lượt xem, lượt thích, follower, bình luận hoặc hoạt động chia sẻ nội dung",
                       "Nội dung quảng bá dịch vụ tạo lưu lượng truy cập giả tạo",
                       "Sử dụng nhiều tài khoản TikTok để phát tán nội dung rác"
                    ],
                },
            ]
        }
    ...
    {
        text: "Thông tin sai lệch gây nguy hiểm",
        children: {
            data: [
                {
                    text: "Y tế",
                ...
                {
                    text: "Các thông tin sai lệch gây nguy hiểm khác",
                    children: {
                        data: [
                            {
                                ...
                                report_text: [
                                   ...
                                   "Thông tin sai lệch về tình trạng khẩn cấp gây ra hoảng loạn",
    ...
    {
        text: "Các hoạt động bất hợp pháp và hàng hóa bị kiểm soát",
        children: {
            data: [
                {
                    text: "Cổ vũ hoạt động phạm tội",
                    children: {
                        data: [
                            {
                                ...
                                report_text: [
                                   ...
                                   "Nội dung cổ động hành vi bóc lột con người, bao gồm buôn người, lao động lệ thuộc, nô lệ giúp việc nhà, mua dâm/bán dâm hoặc mại dâm",
                                   "Nội dung cổ động hành vi phá hoại tài sản",
                                   "Nội dung cổ động hành vi săn bắn hoặc buôn bán trái phép động vật hoang dã",
                                   "Nội dung nhằm mục đích mua, bán, giao dịch hoặc yêu cầu hàng hóa bất hợp pháp hoặc hàng giả",
                ...
                {
                    text: "Ma túy hoặc chất bị kiểm soát",
                    children: {
                        data: [
                            {
                                ...
                                report_text: [
                                   ...
                                   "Nội dung cung cấp thông tin về cách mua các chất bất hợp pháp hoặc chất bị kiểm soát",
                ...
                {
                    text: "Quyền riêng tư và dữ liệu cá nhân",
                    children: {
                        data: [
                            {
                ...
                {
                    text: "Buôn bán động vật hoang dã",
                    children: {
                        data: [
                            {
                        ...
                        data: [
                            {
                                ...
                                report_text: [
                                   ...
                                   "Nội dung quảng bá các mô hình đầu tư với hứa hẹn mang lại lợi nhuận cao, cá cược bất công hoặc bất kỳ hình thức lừa đảo nào khác"
                                ],
                            },
                        ],
                    },
    ...
    {
        text: "Nội dung bạo lực và phản cảm",
        children: {
            data: [
                {
                    ...
                    report_text: [
                       ...
                       "Nội dung trình bày hành vi giết động vật thực",
                       "Nội dung trình bày phần còn lại của con người và động vật sau khi bị chặt chân tay, cắt xẻo, thiêu hoặc đốt",
                       "Nội dung đẫm máu tập trung chính vào vết thương hoặc thương tật hở",
                       "Nội dung trình bày hành vi bạo lực thể chất nghiêm trọng của con người",
                       "Nội dung trình bày hành vi ngược đãi động vật"
                    ],
                },
            ],
        }
    },
    {
        ...
        children: {
            data: [
                {
                    text: "Không thể tìm thấy lý do thích hợp để báo cáo",
                    children: {
                        data: [
                            {
                ...
                {
                    text: "Tôi không quan tâm đến nội dung này",
                    children: {
                        data: [
                            {
